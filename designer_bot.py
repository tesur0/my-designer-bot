...
Стиль: короткие сообщения, по-человечески, спокойно, без пафоса. Никаких звёздочек и markdown форматирования в сообщениях клиенту.
...
- Не давай советов по ценам
- Не говори что запрос нереалистичный
...
async def handle_message(update: Update, context) -> None:
    ...
    if BRIEF_SENT.get(user_id, False):
        await update.message.reply_text("Дизайнер уже получил вашу информацию и скоро свяжется с вами 🙌")
        return
